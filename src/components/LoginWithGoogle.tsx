...
import loginService, { loginOtpHandler, loginServiceHandler, registerOtpHandler } from '../store/services/loginService';
...
const LoginWithGoogle: React.FC<LoginWithGoogleProps> = ({ page, onGoogleLoginSuccess, mobile }) => {
  ...
  const signInWithGoogle = async () => {
    try {
      ...
      if (page === 'login') {
        ...
        const loginDetails = { first_name: userInfo.user.name, last_name: userInfo.user.givenName, email: userInfo.user.email, loginType: 'google', storeId: '2', loginPage: true }
        setLoader(true)
      ...
      <TouchableOpacity onPress={signInWithGoogle} style={styles.touchableOpacityStyle}>
        <View style={styles.subViewStyle}>
          ...
          <View style={styles.wordingViewStyle}>
            <Text style={styles.fontStyle}>Google</Text>
          </View>
        </View>
      </TouchableOpacity>
